...
<div>
    ...
    <form wire:submit="login">
        ...
        <div>
            ...
            <x-text-input wire:model="form.user_cred" id="user_cred" class="block mt-1 w-full" type="text"
                name="user_cred" required autofocus autocomplete="user_cred" />
            <x-input-error :messages="$errors->get('form.user_cred')" class="mt-2" />
        </div>
