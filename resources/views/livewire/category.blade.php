        ...
        <div class="flex justify-between gap-4">
            ...
            <flux:dropdown>
                @if ($category->name == 'Web Development')
                    <flux:button icon:trailing="chevron-down">{{ $category->name }}</flux:button>
                    @if ($category->name == 'Web Development')
                        <flux:menu>
                            <flux:menu.item href="{{ route('categories', 'data-science') }}">Data Science
                            </flux:menu.item>
                ...
                @elseif ($category->name == 'Data Science')
                    ...
                    @endif
                @elseif ($category->name == 'Artificial Intelligence')
                    <flux:button icon:trailing="chevron-down">{{ $category->name }}</flux:button>
